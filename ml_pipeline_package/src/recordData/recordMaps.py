...
folder_path = "/home/danielhixson/ros/noetic/system/src/ML/ml/dataCollection/maps"
...
class rosRecorder:
    ...
    def record(self):
            self.file.close()
            topics = ["/grid_map_visualization/obstacles", "/smf_move_base_mapper/social_grid_map"]
